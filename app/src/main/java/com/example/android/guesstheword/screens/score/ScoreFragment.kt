...
class ScoreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //binding.scoreText.text = scoreFragmentArgs.score.toString() //Diganti dgn LiveData
        //binding.playAgainButton.setOnClickListener { onPlayAgain() }

        //Init ScoreViewModel n ModelFactory
        ...
        binding.scoreFragViewModel = scoreViewModel
        ...
        scoreViewModel.isPlayAgain.observe(this, Observer { playAgain ->
            if (playAgain) {
